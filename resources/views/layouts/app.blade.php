          ...
          <div class="container">
              ...
              <div id="navbar" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav navbar-right">
                      <li>
                          <a href="./index_slider.html">Home</a>
                      </li>
                      <li class="dropdown">
                      ...
                      <li>
                        <a href="./index_slider.html">Gallery</a>
                      </li>
                      <li>
                        <a href="./index_slider.html">Reservations</a>
                      </li>
                      <li>
                        <a href="./index_slider.html">Private Events</a>
                      </li>
                      <li>
                        <a href="./index_slider.html">About Us</a>
                      </li>
                      <li>
                        <a href="./index_slider.html">Careers</a>
                      </li>
                      <li>
                        <a href="./index_slider.html">Special Events</a>
                      </li>
                  </ul>
              </div>
              <!--/.navbar-collapse -->
